...
/*   Updated: 2025/02/17 09:35:40 by jedusser         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class	Contact 
{
	...
	/***********Methods****************/
		...
		void displayContactField(const std::string &field_name, std::string(Contact::*getterFunction)() const, TruncateOption truncate);
